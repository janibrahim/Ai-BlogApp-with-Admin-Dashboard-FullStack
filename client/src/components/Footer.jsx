...
const Footer = () => {
    return (
        <div className='px-6 md:px-16 1g:px-24 xl:px-32 bg-primary/3 text-center md:text-left  '>
            <div className='flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500'>
                <div>
                    <img src={assets.logo} alt="logo" className='w-38 sm:w-44 mx-auto sm:mx-0' />
                ...
                <div className='flex flex-col md:flex-row flex-wrap justify-between w-full md:w-[45%] gap-5'>
